...
public class NjivImage {
	...
	// Listener
	private ArrayList<NjivCaller> listeners = new ArrayList<NjivCaller>();
	
	public void addChangeListener(NjivCaller listener) {
		this.listeners.add(listener);
	}
	
	public void removeChangeListener(NjivCaller listener) {
		this.listeners.remove(listener);
	}

	public ArrayList<NjivCaller> getNjivCaller() {
	...
	public void modify(NjivImageModificator modificator) {
		this.modify(modificator, false);
	}
	
	public void modify(NjivImageModificator modificator, boolean force) {

		if(!force && modificator.hasPanel()) {
			NjivImage me = this;
			...
			EventQueue.invokeLater(new Runnable() {
				public void run() {
					...
					JPanel panel = modificator.getPanel(me);
			...
			this.icon = null;
			try {
				this.image = modificator.modifyImage(this.image);
			} catch(Exception e) {
				System.out.println("[x] Error with the plugin "+modificator.getName()+" : "+e.getLocalizedMessage());
				JOptionPane.showMessageDialog(null,
					    "Error with the "+modificator.getName()+" modification : "+e.getLocalizedMessage(),
					    "Error",
	...
	public void fireChange() {
		for(NjivCaller listener : listeners)
			listener.onChange();
	}
}
